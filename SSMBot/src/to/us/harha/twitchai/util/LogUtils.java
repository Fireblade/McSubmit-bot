...
public class LogUtils
{
    ...
    public static void logMsg(String msg)
    {
        ...
        writeToTextFile("data/logs", "/log_" + g_dateformat.format(g_date) + ".txt", g_datetimeformat.format(g_date) + ": " + msg);
    }
    ...
    public static void logErr(String err)
    {
        ...
        writeToTextFile("data/errors", "/err_" + g_dateformat.format(g_date) + ".txt", g_datetimeformat.format(g_date) + ": " + err);
    }
